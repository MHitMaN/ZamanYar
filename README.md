...
> «هر صفحه وب باید زمان را به زبان آدمی که می‌خواند نشان بدهد.»
>
> MHitMaN
...
## دمو
صفحه دمو داخل پوشه `docs/` قرار دارد. برای نمایش روی GitHub Pages، از تنظیمات repository انتشار از پوشه `docs` را فعال کنید.

اگر دمو content script افزونه را روی صفحه تشخیص ندهد، پیام نصب/فعال‌سازی نشان می‌دهد و همزمان نسخه شبیه‌سازی‌شده برای بررسی UI باقی می‌ماند.
