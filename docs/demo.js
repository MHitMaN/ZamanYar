...
const demoCopy = {
  ...
  ur: {
    ...
    'quote': '«تقویمیں مختلف ہوتی ہیں؛ وقت سب کے لیے قابلِ فہم رہنا چاہیے۔»',
  ...
  ar: {
    ...
    'quote': '«التقاويم تختلف؛ وينبغي أن يبقى الوقت مقروءا للجميع.»',
  ...
  en: {
    ...
    'quote': '“Calendars differ; time should stay readable for everyone.”',
